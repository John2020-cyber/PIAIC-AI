...
def function2():
    ...
    x =    np.arange(10,37).reshape(3,3,3).astype('float64') #wrtie your code here
...
def function5():
    ...
    z = np.zeros(10).reshape(4,5)#wrtie your code here
...
def function11():
    ...
    arr[arr%3==0]=-1#write your code here 
    ans = arr
    return ans
...
def function18():
    ...
    x = np.count_nonzero(x)# Write you code Here
    return x
